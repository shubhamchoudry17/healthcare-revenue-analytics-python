...
> **Note:** the script reads the six source CSVs (`pd.read_csv("Appointments.csv")`, etc.)
> directly from the same directory it's run in — they are **not** inside a `data/` subfolder.
> If you clone this repo, keep all six CSV files in the project root alongside the `.py` file,
> or the script won't find them.
...
# Make sure the six source CSVs are in the same folder as the script
# (Appointments.csv, Patients.csv, Doctors.csv, Hospitals.csv, Treatments.csv, Date_Table.csv)
...
[LinkedIn](https://www.linkedin.com/in/shubham-choudhary-b84484200/) · [Portfolio](https://github.com/shubhamchoudry17) · [Email](shubhamchoudry17@gmail.com)
